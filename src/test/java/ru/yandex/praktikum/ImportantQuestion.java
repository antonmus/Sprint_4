...
public class ImportantQuestion {
    ...
    public ImportantQuestion(int index, String answer){
        this.index = index;
        this.answer = answer;
    }
...
public void setup() {
    ...
    @Test
    public void importantQuestion() {

        MainPageScooter mainPageScooter = new MainPageScooter(driver);

        mainPageScooter.cookikeClick();

        mainPageScooter.expandQuestion(index);

       boolean answerIsDisplayed = mainPageScooter.answerIsDisplayed(answer);
